...
# blackbeans_api/
APPS_DIR = BASE_DIR / "blackbeans_api"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "blackbeans_api.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "blackbeans_api.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "blackbeans_api.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "blackbeans_api.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "blackbeans_api.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "blackbeans_api.users.forms.UserSocialSignupForm"}
...
AUTH_2FA_CHALLENGE_TTL_SECONDS = env.int("AUTH_2FA_CHALLENGE_TTL_SECONDS", default=300)
AUTH_2FA_MAX_ATTEMPTS = env.int("AUTH_2FA_MAX_ATTEMPTS", default=5)
AUTH_2FA_LOCKOUT_SECONDS = env.int("AUTH_2FA_LOCKOUT_SECONDS", default=900)
AUTH_2FA_DEBUG_STATIC_CODE = env("AUTH_2FA_DEBUG_STATIC_CODE", default="")

# Notificacoes por e-mail
FRONTEND_BASE_URL = env("FRONTEND_BASE_URL", default="http://localhost:13000")
...
TIME_PLAY_CUTOFF_ENABLED = env.bool("TIME_PLAY_CUTOFF_ENABLED", default=True)

# Permissoes em lote (story 1.7)
BULK_PERMISSIONS_MAX_ITEMS = env.int("BULK_PERMISSIONS_MAX_ITEMS", default=500)
BULK_PERMISSIONS_PREVIEW_TTL_SECONDS = env.int("BULK_PERMISSIONS_PREVIEW_TTL_SECONDS", default=3600)
